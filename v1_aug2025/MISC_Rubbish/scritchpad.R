...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    # Instructions
    h3("Wine — Chemical Attributes", style = "padding-left: 15px; color: #8B0000;"),
    ...
    p("NOTE: Values are normalized among the training data, and the new attribute 'free.SO2.ratio' is automatically calculated, before input into the predictive model.", 
      style = "padding: 0 15px; font-size: 10px; color: #777; font-style: italic;"),
  ...
  dashboardBody(
    ...
    tags$script(HTML("
      // Note: Window resizing is blocked by most modern browsers for security
      // Users will need to manually resize the window
    ")),
